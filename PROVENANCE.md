...
| [MSD21091969/my-tiny-data-collider](https://github.com/MSD21091969/my-tiny-data-collider/tree/3dd1267eba93cb2886237e55832797ce19e9fcd5) | `3dd1267eba93cb2886237e55832797ce19e9fcd5` | Real React side-panel shell; narrower host scope; simple build boundary; bounded chat-history idea | Best UI/build scaffold after security rewrite |
...
their repos at extraction time; pins verified reachable from `origin/main`.
...
| `legacy/sidepanel-2026-01` | `4de463f` | `my-tiny-data-collider@3dd1267` "feat(frontend): extension build config + LoginPage component" | 2026-01-27 |
...
|---|---|---|---|---|---|
| my-tiny-data-collider | `mailmind-ai-djbuw-50d63f821f84.json` (root) | **GCP service-account key JSON** — `type: service_account`, PEM `private_key` present, full key-id filename | yes | **CRITICAL** | Rotate/revoke the key in GCP now (it must be assumed compromised — tracked in a repo since Jan-2026); purge from history (`git filter-repo`) before any transfer or wider access to the source repo. Not imported here. |
...
- Honest attempt at the pinned source (`my-tiny-data-collider@3dd1267`, `frontend/`):
